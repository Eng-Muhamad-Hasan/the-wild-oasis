...
// We could create yet another layer of abstraction on top of this. We could call this component just <Results>, like: Results({data, count, isPending, columns, rowComponent}). Then <BookingTable> and ALL other tables would simply call that.
